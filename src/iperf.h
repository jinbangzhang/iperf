...
struct iperf_interval_results
{
    ...
    long snd_cwnd;
    long snd_wnd;
    TAILQ_ENTRY(iperf_interval_results)
    irlistentries;
    void *custom_data;
    long rtt;
    long rttvar;
...
struct iperf_stream_result
{
    ...
    TAILQ_HEAD(irlisthead, iperf_interval_results)
    interval_results;
    void *data;
};
...
struct iperf_test
{
    ...
    TAILQ_HEAD(xbind_addrhead, xbind_entry)
    xbind_addrs;   /* all -X opts */
    ...
    SLIST_HEAD(slisthead, iperf_stream)
    streams;
    struct iperf_settings *settings;

    SLIST_HEAD(plisthead, protocol)
    protocols;
    ...
    TAILQ_HEAD(iperf_textlisthead, iperf_textline)
    server_output_list;
};
