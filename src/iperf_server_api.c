...
static void server_timer_proc(TimerClientData client_data, struct iperf_time *nowP) {
...
static void server_stats_timer_proc(TimerClientData client_data, struct iperf_time *nowP) {
    struct iperf_test *test = client_data.p;
...
static void server_reporter_timer_proc(TimerClientData client_data, struct iperf_time *nowP) {
    struct iperf_test *test = client_data.p;
...
static void server_omit_timer_proc(TimerClientData client_data, struct iperf_time *nowP) {
    struct iperf_test *test = client_data.p;
                ...
                if (FD_ISSET(test->prot_listener, &read_set)) {
                    ...
                    if (!is_closed(s)) {
                        ...
                        if (flag != -1) {
                             ...
                             */
                            if (test->protocol->id != Pudp || !sp->sender) {
                                setnonblocking(s, 1);
                            }
